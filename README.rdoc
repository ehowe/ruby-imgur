...
== Usage
  ...
  2. Place a file in your user's $HOME directory with the following contents
    <tt>:client_id: "client_id_from_registering_app"
        :client_secret: "client_secret_from_registering_app"
        :account_username: "username_of_imgur_account"</tt>
...
A File needs to be put in your user's $HOME directory with the following contents
